...
pref("__prefsPrefix__.enableNote", false);
pref("__prefsPrefix__.enableNoteReplaceMode", false);
pref("__prefsPrefix__.translateSource", "caiyun_common");
pref("__prefsPrefix__.dictSource", "");
pref("__prefsPrefix__.sourceLanguage", "en");
pref("__prefsPrefix__.targetLanguage", "zh");
pref("__prefsPrefix__.fontSize", "13");
pref("__prefsPrefix__.lineHeight", "1.8");
...
pref("__prefsPrefix__.caiyuntransUsername", "");
pref("__prefsPrefix__.caiyuntransPassword", "");
pref("__prefsPrefix__.caiyuntransDictNo", "");
pref("__prefsPrefix__.caiyuntransMemoryNo", "");
pref("__prefsPrefix__.caiyuntransDictLibList", "[]");
pref("__prefsPrefix__.caiyuntransMemoryLibList", "[]");
